...
namespace CourseLibrary.API.Controllers
{
    ...
    public class AuthorCollectionsController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<AuthorDto>> CreateAuthorCollection(IEnumerable<AuthorForCreationDto> authorCollection)
        {
            ...
            var authorColelctToReturn = _mapper.Map<IEnumerable<AuthorDto>>(authorEntities);
            var idsAsString = string.Join(",", authorColelctToReturn.Select(a => a.Id));
            return CreatedAtRoute("GetAuthorCollection",
                new { ids = idsAsString },
                 authorColelctToReturn);
        }
    }
}
